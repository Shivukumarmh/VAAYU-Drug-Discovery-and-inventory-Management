...
def desc_calc():
    ...
    output_dir = "C:\\Users\\abhis\\Desktop\\cancer"
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)

    # Absolute path to input file and descriptor output
    input_file = os.path.join(output_dir, 'molecule.smi')
    descriptor_output = os.path.join(output_dir, 'descriptors_output_cancer.csv')
    descriptor_list_file = os.path.join(output_dir, 'descriptor_list_cancer.csv')
...
def build_model(input_data):
    ...
    model_file = 'C:\\Users\\abhis\\Desktop\\cancer\\cancer_prediction_model (1).pkl'
...
if st.sidebar.button('Predict'):
    if uploaded_file is not None:
        ...
        descriptor_output = os.path.join("C:\\Users\\abhis\\Desktop\\cancer", 'descriptors_output_cancer.csv')
        if os.path.exists(descriptor_output):
            ...
            descriptor_list_file = os.path.join("C:\\Users\\abhis\\Desktop\\cancer", 'descriptor_list_cancer.csv')
