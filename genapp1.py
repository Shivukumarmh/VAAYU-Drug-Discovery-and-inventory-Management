...
def load_generator():
    return tf.keras.models.load_model('C:\\Users\\abhis\\Desktop\\gen ai model\\generator_model.h5')
...
def main():
    ...
    num_samples = st.slider("Number of molecules to generate", min_value=1, max_value=50, value=10)
