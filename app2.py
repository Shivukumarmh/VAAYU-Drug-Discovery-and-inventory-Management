...
def desc_calc():
    ...
    output_dir = "C:\\Users\\abhis\\Desktop\\dengue"
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)

    # Absolute path to input file and descriptor output
    input_file = os.path.join(output_dir, 'molecule(1).smi')
    descriptor_output = os.path.join(output_dir, 'des_output.csv')
    descriptor_list_file = os.path.join(output_dir, 'des_list.csv')
...
def build_model(input_data):
    ...
    model_file = 'C:\\Users\\abhis\\Desktop\\dengue\\dengue_model.pkl'
...
if st.sidebar.button('Predict'):
    if uploaded_file is not None:
        ...
        input_file = os.path.join("C:\\Users\\abhis\\Desktop\\dengue", 'molecule(1).smi')
        ...
        descriptor_output = os.path.join("C:\\Users\\abhis\\Desktop\\dengue", 'des_output.csv')
        if os.path.exists(descriptor_output):
            ...
            descriptor_list_file = os.path.join("C:\\Users\\abhis\\Desktop\\dengue", 'des_list.csv')
